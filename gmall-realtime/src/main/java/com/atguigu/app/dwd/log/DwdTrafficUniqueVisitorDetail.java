...
public class DwdTrafficUniqueVisitorDetail {
    public static void main(String[] args) throws Exception {
        ...
        String pageTopic = "dwd_traffic_page_id";
        String groupId = "unique_visitor_detail_0212";
        DataStreamSource<String> kafakDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer(pageTopic, groupId));

        //TODO 3,转为JSON对象并且过滤数据
        SingleOutputStreamOperator<JSONObject> jsonObjDS = kafakDS.process(new ProcessFunction<String, JSONObject>() {
            @Override
