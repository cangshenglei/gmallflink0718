...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        //TODO 2,读取KAFKA WDW 层三个主题的数据创建流
        ...
        KeyedStream<TrafficPageViewBean, Tuple4<String, String, String, String>> keyedStream = pageViewWithWMDS.keyBy(new KeySelector<TrafficPageViewBean, Tuple4<String, String, String, String>>() {
            ...
            public Tuple4<String, String, String, String> getKey(TrafficPageViewBean trafficPageViewBean) throws Exception {
                return new Tuple4<>(trafficPageViewBean.getAr()
                        , trafficPageViewBean.getCh(), trafficPageViewBean.getIsNew(), trafficPageViewBean.getVc()
                );
            }
        });
     ...
     /*   windowedStream.reduce(new ReduceFunction<TrafficPageViewBean>() {
        ...
        //全量聚合:攥着在一起处理  -----> 百分比指标,排序,可以得到窗口详细数据
