        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                for (int i = 0; i < columnCount; i++) {
                    String columnName = metaData.getCatalogName(i + 1);
...
//将T对象加入集合
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<JSONObject> queryList = queryList(connection, "select * from GMALL220212_REALTIME.DIM_BASE_TRADEMARK where id='13'", JSONObject.class, true);
